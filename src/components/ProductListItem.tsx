...
const ProductListItem = ({ product }: ProductListItemProps) => {
    ...
    return (
        ...
        // <Link href={`/menu/${product._id}`} asChild >
        <Link href={`/(tabs)/two`} asChild >
            <Pressable style={styles.container}>
                <Image
                    source={{ uri: isValidImageUrl(product.image) ? product.image : defaultImageUrl }}
                    style={styles.image}
                    resizeMode="contain"
                />
                ...
                <Text style={styles.price}> {product.inStock} </Text>
...
// using previous products object , not the api m will use this again later
// const ProductListItem = ({ product }: ProductListItemProps) => {
//     return (
//         // aschild likha take main container ke styles khrab na hon
//         // <Link href={"/product"} asChild > //this when we dont have dynamuc route
